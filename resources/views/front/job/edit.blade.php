        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <form id="editJobForm" name="editJobForm" action="post">
                        <div class="card border-0 shadow mb-4 ">
                            <div class="card-body card-form p-4">
                                        ...
                                        <select class="form-select" name="jobType" id="jobType">
                                            ...
                                            @if ($jobtypes->isNotEmpty())
                                                @foreach ($jobtypes as $jobType)
                                                    <option {{ $job->job_type_id == $job->jobType->id ? 'selected' : '' }}
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" value="" name="responsibility" id="responsibility" cols="5"
                                        rows="5" placeholder="Responsibility">{{ $job->responsibility }}</textarea>
                                </div>
                                <div class="mb-4">
                                    <label for="" class="mb-2">Qualifications</label>
                                    <textarea class="form-control" value="" name="qualifications" id="qualifications" cols="5"
                                        rows="5" placeholder="Qualifications">{{ $job->qualifications }}</textarea>
                                </div>


                                <div class="mb-4">
                                    <label class="mb-2">Experince<span class="req">*</span></label>
                                    <select name="experience" id="experience" class="form-control">
                                        ...
                                        <option value="10_Plus" {{ $job->experience == 10 ? 'selected' : '' }}>10+ Years
                                        </option>
                                    </select>
                                    <p></p>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{ $job->compnay_website }}" placeholder="Website"
                                        id="compnay_website" name="compnay_website" class="form-control">
                                </div>
                            </div>
