                                ...
                                <table class="table ">
                                    <thead class="bg-light">
                                        <tr>
                                            ...
                                            <th scope="col">Applied Date Created</th>
                                        ...
                                        @if ($jobApplications->isNotEmpty())
                                            @foreach ($jobApplications as $jobApplication)
                                                <tr class="active">
                                                    ...
                                                    <!-- Assuming there is a relationship or method for counting applications -->
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="action-dots float-end">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item" href="{{route('jobDetail', $jobApplication->job->id)}}"><i
    ...
    <script type="text/javascript">
        function removeJob(id) {
            if (confirm('Are you sure you want to Remove this job?')){
                 ...
                 $.ajax({
                    url: '{{ route("job.removeJob") }}',
                    type: 'post',
                    data: {id: id},
                    dataType:'json',
                    success: function(response) {
                        window.location.href = '{{ route("job.myJobApplication") }}';
                    },
