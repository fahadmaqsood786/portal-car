                ...
                <div class="col-md-4 col-lg-3 sidebar mb-4">
                    <form action="{{ route('jobs') }}" method="get" name="searchForm" id="searchForm">
                     <div class="card border-0 shadow p-4">
                        <div class="mb-4">
                            <h2>Keywords</h2>
                            <input type="text" name="keyword" id="keyword" placeholder="Keywords" value="{{ Request::get('keyword') }}" class="form-control">
                        </div>

                        <div class="mb-4">
                            <h2>Location</h2>
                            <input type="text" name="location" id="location" placeholder="Location" value="{{ Request::get('keyword') }}" class="form-control">
                        </div>
                            ...
                            @if ($jobTypes->isNotEmpty())
                                @foreach ($jobTypes as $jobType)
                                    <div class="form-check mb-2">
                                        <input {{ (in_array($jobType->id, $jobTypeArray)) ? 'checked' : '' }} class="form-check-input " name="job_Type" id="job_Type" type="checkbox"
...
<script>
    ...
    if (checkJobTypes.length > 0) {
        url += '&job_Type=' + checkJobTypes.join(',');
    }
    url += '&sort='+sort;
